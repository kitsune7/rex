...
def create_app_context(
    ...
    return AppContext(
        event_bus=event_bus,
        timer_manager=timer_manager or TimerManager(event_bus=event_bus),
        reminder_manager=reminder_manager or ReminderManager(event_bus=event_bus),
        settings=settings or load_settings(),
        audio_manager=audio_manager or AudioManager(event_bus=event_bus),
    )
